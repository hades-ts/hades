...
Text command support is located in the `@hades-ts/text-commands` package.
...
```ts
import { TextCommand, TextCommandContext, command, description } from "@hades-ts/text-commands";
