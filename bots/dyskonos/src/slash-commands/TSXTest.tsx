...
const ui = custom => <>
    <ActionRow>
        <Button style={ButtonStyle.Primary} label={custom} customId="primary" />
        ...
        <LinkButton style={ButtonStyle.Link} label="Link" url="https://discord.js.org" />
    </ActionRow>
    <ActionRow>
        <StringSelectMenu customId="select" placeholder="Select an option">
            <SelectMenuOption description="This is the first option" label="First" value="first" />
    ...
    <ActionRow>
        <ChannelSelectMenu maxValues={5} customId="channel" placeholder="Select a channel" />
    </ActionRow>
</>
