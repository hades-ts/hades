import { ActionRowBuilder, ButtonBuilder, ButtonInteraction, Collection, CollectorFilter, ComponentType, InteractionCollector, InteractionType, Message } from "discord.js";
...
export abstract class BaseButtonInteraction {
    ...
    protected createCollector(timeout = 10000) {
        const filter: CollectorFilter<[ButtonInteraction<"cached">]> = 
            (...interactions: ButtonInteraction<"cached">[]) => 
