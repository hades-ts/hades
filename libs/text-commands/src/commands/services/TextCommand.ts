...
export abstract class TextCommand {
    ...
    protected context: TextCommandContext;
    ...
    get activity() {
        return this.msg.activity;
    }
    get application() {
        return this.msg.applicationId;
    }
    get args() {
    ...
    get deletable() {
        return this.msg.deletable;
    }
    get editable() {
        return this.msg.editable;
    }
    get editedAt() {
        return this.msg.editedAt;
    }
    get editedTimestamp() {
        return this.msg.editedTimestamp;
    }
    get embeds() {
    ...
    get mentions() {
        return this.msg.mentions;
    }
    get msg() {
        return this.context.msg;
    }
    get pinnable() {
        return this.msg.pinnable;
    }
    get pinned() {
        return this.msg.pinned;
    }
    get reactions() {
    ...
    get webhookID() {
        return this.msg.webhookId;
    }

    get members() {
        return this.discord.getMembers(this.guild.id);
    }
    get categories() {
        return this.discord.getCategories(this.guild.id);
    }
    get channels() {
        return this.discord.getChannels(this.guild.id);
    }
    get roles() {
        return this.discord.getRoles(this.guild.id);
    }

    getMember(memberId: string) {
        return this.discord.getMember(this.guild.id, memberId);
    }
    getOwner() {
        return this.discord.getOwner(this.guild.id);
    }
    getChannel(channelId: string) {
        return this.discord.getChannel(this.guild.id, channelId);
    }
    getRole(roleName: string) {
        return this.guild.roles.resolve(roleName);
    }
